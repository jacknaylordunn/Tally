            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in print:hidden">
                <div className="glass-panel w-full max-w-md p-6 rounded-2xl shadow-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3"><label className="block text-xs font-bold uppercase text-slate-500 dark:text-slate-400">Repeat Pattern</label><div className="grid grid-cols-2 gap-3"><button onClick={() => setRepeatMode('daily_week')} className={`p-3 rounded-lg border-2 text-left transition-all ${repeatMode === 'daily_week' ? 'border-brand-500 bg-slate-800 text-white shadow-md' : 'border-slate-200 dark:border-slate-700 text-slate-500'}`}><span className="block font-bold text-sm">Every Day</span><span className="text-[10px] opacity-70">Rest of this week</span></button><button onClick={() => setRepeatMode('custom')} className={`p-3 rounded-lg border-2 text-left transition-all ${repeatMode === 'custom' ? 'border-brand-500 bg-slate-800 text-white shadow-md' : 'border-slate-200 dark:border-slate-700 text-slate-500'}`}><span className="block font-bold text-sm">Custom</span><span className="text-[10px] opacity-70">Specific days & dates</span></button></div></div>
